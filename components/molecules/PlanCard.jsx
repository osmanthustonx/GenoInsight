...
function PlanCard({ title, content, prePrice, price, hot }) {
  return (
    <div className="relative flex flex-col items-center w-[375px] h-[360px] bg-white rounded-lg px-[18px] pt-[36px] pb-[30px] shadow-[0_14px_30px_0_rgba(0,0,0,0.1)]">
